...
"""
Utility functions related to the Merlin Image Binary format.
"""
import numpy as np
...
def mibheader(filepath, hoffset = 0):
    ...
    # TODO: add more from the header
    header_ID, seq_num, data_offset, nchips, size_x, size_y, dtype_str, *_ = header.decode('ascii').split(',')

    # Special case : dtype
    # For NumPy, U16 is unicode; unsigned 16-bit (2 bytes) integers is u2
    # Also, must be big-endian ('>'), which is why
